...
| **Hallazgo nuevo (02-09-2026, vía SAPI-32): primer caso con regla activa sobre datos 100% reales** | Al ampliar la ventana a 5 años de histórico NASA FIRMS + meteo DMC real (ver avance SAPI-32 en R-INTEGRACION-01), **VP-025 / 2022-12-11** es el primer caso encontrado donde la regla 30-30-30 se cumple (temperatura=30.7 °C, humedad=22 %, viento=30.37 km/h) usando datos reales de punta a punta — 6 detecciones NASA FIRMS reales dentro del polígono de la celda (contención estricta, sin proxy), unidas a meteo real de la estación 330007 sin fuga de datos (evento y estación distintos de la muestra n=12 de feb-2025 de arriba). Es **un solo caso** — no cambia la conclusión de "mixta, no calibrada" de arriba, pero es la primera vez que la regla sintética y una ignición real confirmada coinciden con datos verificables, no sintéticos, en ningún lado del cálculo. Ver detalle en el avance SAPI-32 (R-INTEGRACION-01). |
