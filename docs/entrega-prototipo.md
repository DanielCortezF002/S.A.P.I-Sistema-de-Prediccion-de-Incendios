...
| **OE3** Dashboard Streamlit + Folium | UI desacoplada, caché, mapa interactivo | Streamlit Cloud, `app/app.py`, build `demo-corredor-50cells-v9` |
...
|-------|----------------|-------|----------------|
| 2025-02-09 | Mayoría verde/ámbar, costa húmeda | 0 | 0 |
...
- [ ] Build sidebar (en “Detalles técnicos”): `demo-corredor-50cells-v9`
