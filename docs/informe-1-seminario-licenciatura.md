...
**Nota sobre R-ETIQUETA-01, hallazgo del 02-09-2026 — retractado el 06-09-2026:** al ampliar la ventana de análisis a 5 años de histórico NASA FIRMS con meteo DMC real, se había identificado un caso (celda VP-025, fecha 2022-12-11) donde la regla 30-30-30 parecía cumplirse con datos 100% reales. Al reverificarlo (`scripts/reverificar_hallazgo_2022_12_11.py`) se encontró que los tres valores citados (temperatura, humedad, viento) provenían de detecciones distintas en momentos distintos, no de una misma observación real — ninguna detección individual cumple las tres condiciones a la vez. El hallazgo era un artefacto de agregación (max/min sobre el polígono de la celda), no una ignición real con condiciones 30-30-30 simultáneas. Se retracta: no hay, a la fecha, ningún caso confirmado de regla 30-30-30 cumplida sobre una detección real. Ver detalle en [`docs/matriz-riesgo.md`](matriz-riesgo.md).
