...
def test_render_folium_map_method(mock_render, mock_st_folium):
    ...
    with patch.object(SapiDashboard, "load_cached_resources", return_value=MagicMock(get_spatial_risk_map=MagicMock(return_value=gdf))):
